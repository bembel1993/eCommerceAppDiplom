            ...
            <div class="login-grids">
                <div class="login">
                    <div class="login-bottom">
                        <h3><font color="#4169e1">Write Message</font></h3>
                        <%
                            String success = (String) session.getAttribute("success-message");
                            if (success != null) {
                                session.removeAttribute("success-message");
                        %>
                        <div class='alert alert-success' id='success' style="width: 680px;">Your message
                            Successfully.
                        </div>
                        <%
                            }
                        ...
                        %>
                        <div class="alert alert-danger" id='danger' style="width: 680px;">Your message
                        ...
                        <form action="AddMessage" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" placeholder="Write here" required=""
                                       style="min-height: 100px; width: 680px;" name="message_send">
                            </div>
                            <div class="sign-up">
...
<div class="container">
    <div class="container">
            <div class="col-md-3 coupons-gd">
                ...
                <h4><font color="#4169e1">CHAT</font></h4>
            </div>
    </div>
    <%
