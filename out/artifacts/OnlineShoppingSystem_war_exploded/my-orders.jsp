...
<div class="page-head">
    <div class="container">
        <h3><font color="#4169e1">My Orders</font></h3>
    </div>
</div>
...
<div class="table-responsive">
    <table class="table table-bordered" width="300px">
        ...
        <tr class="rem1">
            ...
            <td class="invert"><h4><font color="black"><%=totalProduct.getInt(1)%>
            </font></h4>
            </td>
            ...
            <td class="invert"><h4><font color="black"><%=totalProduct.getString(13)%>
            </font></h4>
            </td>
            <td class="invert"><h4><font color="black"><%=totalProduct.getString(15)%>
            </font></h4>
            </td>
            <%
                //If order is delivered
                if (totalProduct.getString(14).equals("Deliver")) {
            %>
